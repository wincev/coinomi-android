...
import com.coinomi.core.coins.FreicoinMain;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(FreicoinMain.get(),     new ServerAddress("electrum.freicoin.info", 50001))
                                                    new ServerAddress("verify.ddns.net", 5001))
    );
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_ICONS.put(CoinID.FREICOIN_MAIN.getCoinType(), R.drawable.freicoin);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.FREICOIN_MAIN.getCoinType(), "http://freicoin.info/tx/%s");
    }
